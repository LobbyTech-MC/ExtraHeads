...
public class ExtraHeads extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        category = new Category(new NamespacedKey(this, "heads"), new CustomItem(SkullItem.fromHash("5f1379a82290d7abe1efaabbc70710ff2ec02dd34ade386bc00c930c461cf932"), "&7更多头颅", "", "&a> 点击打开"), 1);
        recipeType = new RecipeType(new NamespacedKey(this, "decapitation"), new CustomItem(Material.IRON_SWORD, "&6击杀指定生物"));
        ...
        registerHead("蜘蛛r头颅", EntityType.SPIDER, "cd541541daaff50896cd258bdbdd4cf80c3ba816735726078bfe393927e57f1");
        ...
        if (SlimefunPlugin.getMinecraftVersion().isBefore(MinecraftVersion.MINECRAFT_1_16)) {
            ...
            registerHead("僵尸猪人头颅", EntityType.PIGLIN, "11d18bbd0d795b9ac8efaad655e3d0c59fcbb9b964c2a9948ef537f4a3fbbf87");
            registerHead("僵尸猪人头颅", EntityType.ZOMBIFIED_PIGLIN, "e935842af769380f78e8b8a88d1ea6ca2807c1e5693c2cf797456620833e936f");
    ...
    private void registerHead(String name, EntityType type, String texture) {
        try {
            ...
            new MobHead(category, item, recipeType, new CustomItem(item, "&r击杀 1 " + StringUtils.format(type.toString()), "&7几率: &e" + chance + "%")).register(this, () -> mobs.put(type, item));
        }
        catch (Exception x) {
